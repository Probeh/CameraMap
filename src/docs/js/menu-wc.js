...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">Camera-Map</a>
                </li>
                ...
                <li class="chapter">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-b1bd717672c00f417d67aef27d09847b"' : 'data-target="#xs-components-links-module-AppModule-b1bd717672c00f417d67aef27d09847b"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-b1bd717672c00f417d67aef27d09847b"' :
                                            'id="xs-components-links-module-AppModule-b1bd717672c00f417d67aef27d09847b"' }>
                                            <li class="link">
                                        ...
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-CameraMapModule-772c68f872f21f424e873a396d00cfa9"' :
                                            ...
                                            <li class="link">
                                                <a href="components/CameraListComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">CameraListComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/CameraMapComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">CameraMapComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                                <li class="chapter inner">
                    ...
                    <li class="chapter">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                <li class="link">
                                    <a href="injectables/CameraFormService.html" data-type="entity-link">CameraFormService</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="interceptors-links"' : 'id="xs-interceptors-links"' }>
                            <li class="link">
                                <a href="interceptors/ResourceInterceptor.html" data-type="entity-link">ResourceInterceptor</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
